...
func newFloatingIPDisableProtectionCommand(cli *state.State) *cobra.Command {
	cmd := &cobra.Command{
...
func runFloatingIPDisableProtection(cli *state.State, cmd *cobra.Command, args []string) error {
	idOrName := args[0]
